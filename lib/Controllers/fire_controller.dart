...
import 'package:appointment_booking_app/Screen/Firebase/sign_in.dart';
import 'package:appointment_booking_app/Screen/User/user_screen.dart';
      ...
      if (documentSnapshot.exists) {
        ...
        await FirebaseFirestore.instance
          ...
          if (documentSnapshot.exists) {
            ...
            // storeAdminToken(userData["userUid"]);
            setLoading(false);
            setPreference(userData);
        ...
        await FirebaseFirestore.instance
          ...
          if (documentSnapshot.exists) {
            ...
            storeDocToken(userData["userUid"]);
            setLoading(false);
            setPreference(userData);

            go == "go" ? debugPrint(go) : Get.offAll(DoctorScreen(
                userName: userData["userName"],
                userEmail: userData["userEmail"],
                userUid: userData["userUid"],
              ));
